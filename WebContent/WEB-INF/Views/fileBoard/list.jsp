...
<body>
	...
	<div id="content">
		...
		<div id="write" >
			<a href="${root}/fileBoard/write.do?pageNumber=${pageNumber}">글쓰기</a>
		</div>
		...
		<div id="board">
			...
			<div class="content">
				...
				<span>
					...
					<a href="${root}/fileBoard/read.do?boardNum=${dto.boardNum}&pageNumber=${pageNumber}">${dto.title}</a>
				</span>
