...
<head>
	...
	<script type="text/javascript">
		function replyFun(root, boardNum, groupNum, sequenceNum, sequenceLev, pageNumber){
			var url = root + "/fileBoard/write.do?boardNum=" + boardNum;
		...
		function delFun(root, boardNum, pageNumber) {
			var url = root + "/fileBoard/delete.do?boardNum=" + boardNum;
			url += "&pageNumber=" + pageNumber;
			//alert(url);
			location.href = url;
		...
		function updateFun(root, boardNum, pageNumber) {
			var url = root + "/fileBoard/update.do?boardNum=" + boardNum;
			url += "&pageNumber=" + pageNumber;
			// alert(url);
			location.href = url;
		}
